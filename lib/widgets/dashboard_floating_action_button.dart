...
class DashboardFloatingActionButton extends StatefulWidget {
  ...
  const DashboardFloatingActionButton({super.key, required this.analytics, required this.observer, required this.callNumberStore, required this.inviteFriendShareMessage});

  @override
  State<DashboardFloatingActionButton> createState() => _DashboardFloatingActionButtonState();
}
